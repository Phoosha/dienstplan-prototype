...
<?php 
	if ($this->ion_auth->is_admin()) {
		echo form_dropdown('user_id', $users, $this->ion_auth->get_user_id());
	}
	echo form_submit('save', 'Alle speichern', 'class="pure-button secondary-button"');
?>
</p>
<?php echo form_close(); ?>
