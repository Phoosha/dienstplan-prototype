...
$config['default_rounds'] = 12;		// This does not apply if random_rounds is set to true
...
$config['max_password_length']        = 72;                  // Maximum Allowed Length of Password
...
$config['threshold_attempts']         = 3;					 // The number of attempts when we start showing the remaining attempts
